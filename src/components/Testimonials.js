...
function Testimonials() {
  ...
  return (
    <div className="bg-scroll bg-[url('/Dove ext 1-8829.jpg')] object-cover md:h-[340px] mt-14">
          ...
          <SwiperSlide>
            <div className="flex flex-col w-[100%] ">
              <figure className="max-w-screen-md mx-auto text-center py-6 w-[100%]">
                <svg
                  className="w-10 h-10 mx-auto mb-3 text-gray-40 text-green-700"
                  aria-hidden="true"
                ...
                <blockquote>
                  <p className=" italic font-medium text-gray-900  bg-white p-4 rounded-lg m-4">
                    {
